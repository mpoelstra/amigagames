# Sparkpaw 0.7.0-alpha.6 — Tune the soundtrack, test every sound, and pause the storm
...
- **Try every sound in HD and WHDLoad.** SOUNDTEST includes all 16 effects and
  the four themes: Hero Drive, Neon Sky, Copper Sprint and Iron Horizon.
...
Use the two alpha.6 ADFs together. Updated disk identification prevents mixing
