# Release 0.7.0-alpha.6 — Phase 7A.3 audio controls and pause

> Preserved pre-release working draft. Used as the basis for alpha.7; the
> copied artifact hashes and verification statements below do not establish
> a separately packaged or published alpha.6 release. See RELEASE_0_7_0_ALPHA_7.md.

Current checkpoint: **0.7.0-alpha.6 / Phase 7A.3**, released 9 September 2026.
...
Alpha.6 adds a gameplay-only AUDIO MODE to OPTIONS in every edition: SFX ONLY,
MUSIC ONLY or SFX + MUSIC (default). HD/WHDLoad add SOUNDTEST with all 16
effects and Hero Drive, Neon Sky, Copper Sprint and Iron Horizon. Explicit
previews are independent of gameplay mode and restore Neon Sky when returning.
The READY UI uses a shared centred label/value gutter and BACK actions.

P now pauses and resumes both gameplay sections. Simulation, animation and
elapsed level time freeze on the last complete frame; gameplay music continues
and an already playing effect may finish. Raw-key edge latching prevents held-P
keyboard repeat from toggling repeatedly. Escape and WHDLoad F10 remain live.
...
Evidence inherited from alpha.5: repeated user 68020/68030 audio/gameplay trials were positive; the
...
pass. User-supplied FS-UAE screenshots verify the evolving alpha.6 OPTIONS and
SOUNDTEST presentation. Alpha.6 preview audio, gameplay modes, P pause,
WHDLoad and newly packaged ADF runtime remain unaccepted until separately played.
Final real-hardware, physical floppy/Gotek and
...
Next step: test alpha.6 first in FS-UAE/68030, then on 68020 and real hardware.
No routine automatic FS-UAE tests or further microbenchmarks.
...
WHDLoad was rebuilt with the shared gameplay backend and updated alpha.6 slave.
...
The live itch download page was checked again on 9 September before alpha.6:
...
ALPHA6_ARTIFACT_SHA256.json also records every file in the HD review drawer.

| Artifact | Bytes | SHA-256 |
|---|---:|---|
| Sparkpaw-0.7.0-alpha.6.zip | 1112799 | `5fa48e03ef4e790848b7eb1aa57b151b8f4024e95c76bf904191cfb202e75d7a` |
| Sparkpaw-0.7.0-alpha.6.lha | 1125218 | `7c4a958af996baa58b7c9e4b03f0b07e75a5ff7023876f4fc87fee887ad73f46` |
| Sparkpaw-0.7.0-alpha.6-Disk1.adf | 901120 | `df10b257e392c5b7d12cf05794e02098d3f2fb4b4f42d1c6ab7c9eab899916df` |
| Sparkpaw-0.7.0-alpha.6-Disk2.adf | 901120 | `6c664ea59f30c042ce2263f27a3d2190f2143ec755aa4fd7ffb6df4326fdfbb8` |
| Sparkpaw-0.7.0-alpha.6-WHDLoad.zip | 1120914 | `c565f51db6aac34469f99efe4b114fc98e0bb70984037bf17b13ea3f9b787cd1` |
| Sparkpaw-0.7.0-alpha.6-WHDLoad.lha | 1132681 | `dc51dbc793d7b6913f39453f5df91c123149b02ad5eca130c2d96dc0df5ee47d` |
