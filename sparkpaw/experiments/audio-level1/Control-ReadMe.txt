...
CONTROL: no timing reads or instrumentation wrappers. Basic event,
music-tick and mixed-buffer counters remain, matching the measured run.
This provides the listening/behaviour control for measurement overhead;
it does not independently measure CPU usage.
