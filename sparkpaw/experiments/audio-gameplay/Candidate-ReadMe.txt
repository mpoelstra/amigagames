...
B: Copper Sprint, three music channels + two block-mixed effect voices.
OS scheduling stays forbidden; only EXTER/CIA-B music and AUD3 mixer
interrupts are enabled. Keyboard stays polled. Existing per-game-update
cooldowns remain; sample playback runs independently of rendered frames.
