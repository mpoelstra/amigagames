...
def extra_life():
    # Bright secret reward, distinct from the three-note shard pickup.
    return mix(notes((659,784,988,1319),.085),
               gain(delay(tone(.20,1976,10,-240),.25),.42))
...
EFFECTS=[
    ...
    ("extra-life",extra_life,62,10,20),
]
