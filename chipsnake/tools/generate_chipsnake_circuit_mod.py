...
OUTPUT = Path("music/chipsnake-title.mod")
SAMPLE_RATE = 8363
...
def make_pattern(chord, melody, ending=False):
    ...
    chord_notes = {
        # Compensate for ARP PULSE's 64-sample cycle.
        "CM": ("C1", "EB1", "G1"),
        "AB": ("AB1", "C2", "EB2"),
        "BB": ("BB1", "D2", "F2"),
        "FM": ("F1", "AB1", "C2"),
...
def build():
    melodies = [
        ["C3", None, "EB3", "G3", "C4", "G3", "EB3", "D3",
         "C3", "EB3", "G3", "BB3", "G3", "F3", "EB3", "D3"],
        ["AB3", None, "C4", "AB3", "EB3", "F3", "G3", "EB3",
         "BB3", "AB3", "G3", "F3", "EB3", "D3", "C3", None],
        ["BB3", "G3", "F3", "G3", "BB3", None, "D3", "F3",
         "G3", "F3", "EB3", "D3", "C3", "D3", "EB3", "G3"],
        ["F3", "AB3", "C4", "AB3", "G3", "F3", "EB3", "C3",
         "D3", "F3", "AB3", "G3", "F3", "EB3", "D3", None],
        # The central hook returns in several guises across the longer tune.
        ["C3", "G3", "EB3", "G3", "C4", "BB3", "G3", "EB3",
         "F3", "G3", "BB3", "G3", "EB3", "D3", "C3", "G3"],
        ["AB3", "C4", "EB3", "AB3", "C4", "AB3", "G3", "EB3",
         "F3", "AB3", "C4", "BB3", "AB3", "G3", "F3", "EB3"],
        ["BB3", "F3", "D3", "F3", "BB3", "C4", "BB3", "G3",
         "F3", "D3", "F3", "G3", "BB3", "G3", "F3", "D3"],
        ["C4", "BB3", "G3", "EB3", "F3", "G3", "C4", "BB3",
         "AB3", "G3", "F3", "EB3", "D3", "EB3", "G3", "C4"],
    ]
    patterns = [
        make_pattern("CM", melodies[0]),
        make_pattern("AB", melodies[1]),
        make_pattern("BB", melodies[2]),
        ...
        make_pattern("FM", melodies[3]),
        make_pattern("AB", melodies[5]),
        make_pattern("BB", melodies[2], True),
        make_pattern("CM", melodies[4], True),
    ]
    order = bytes(range(12))
    ...
    module = b"CHIPSNAKE CIRCUIT".ljust(20, b"\0")
