...
that `sparkpaw/dist` contains exactly the four current consistently versioned
artifacts: LHA, ZIP, ADF and source ZIP. Do not delete ignored local evidence or
backups while cleaning release outputs.
